...
export function meta() {
  return [
    { title: 'Research - UN Speeches' },
    {
      name: 'description',
      content:
        'Data analysis and research findings from the UN Speeches database.',
    },
  ]
}
    ...
    <PageLayout maxWidth="wide">
      <div className="mb-12">
        ...
        <p className="text-xl text-gray-600 max-w-3xl">
          Deep dives and data analysis uncovering trends, patterns, and insights
          from over 75 years of General Assembly debates.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        >
          ...
          <div className="p-4 md:p-6">
            ...
            <p className="text-gray-600 text-sm mb-3 md:mb-4 line-clamp-3">
              Who do world leaders cite to claim moral authority? From Mandela
              to Churchill, we analyze the most frequent citations in the last
              15 years.
            </p>
        ...
        >
          ...
          <div className="p-4 md:p-6">
            <div className="flex items-center gap-2 mb-2 md:mb-3">
              <Badge variant="blue">Case Study</Badge>
              <span className="text-xs text-gray-500">Jan 2026</span>
            </div>
            ...
            <p className="text-gray-600 text-sm mb-3 md:mb-4 line-clamp-3">
              From Cold War strategic coordinate to global climate harbinger. A
              75-year evolution of sovereignty thinking in the UN Hall.
            </p>
        ...
        >
          ...
          <div className="p-4 md:p-6">
            <div className="flex items-center gap-2 mb-2 md:mb-3">
              <Badge variant="blue">Data Analysis</Badge>
              <span className="text-xs text-gray-500">Jan 2026</span>
            </div>
            ...
            <p className="text-gray-600 text-sm mb-3 md:mb-4 line-clamp-3">
              From 1947 partition to 2024 urgency. How a concept took 54 years
              to become the universal diplomatic framework for
        ...
        >
          ...
          <div className="p-4 md:p-6">
            <div className="flex items-center gap-2 mb-2 md:mb-3">
              <Badge variant="blue">Discourse Analysis</Badge>
              <span className="text-xs text-gray-500">Jan 2026</span>
            </div>
            ...
            <p className="text-gray-600 text-sm mb-3 md:mb-4 line-clamp-3">
              From Cold War confrontation to moral critique. How UN speeches
              about military buildup changed from superpower accusations to
              small-nation advocacy.
            </p>
      ...
      <div className="mt-16 pt-12 border-t border-gray-200">
        <div className="mb-8">
          ...
          <p className="text-lg text-gray-600 max-w-3xl">
            This research was conducted using Claude Code, an AI coding agent,
            to explore whether such tools can meaningfully enhance research in
            the humanities.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-10">
          <div className="bg-white rounded-xl border border-gray-200 p-6">
            ...
            <p className="text-gray-600 text-sm">
              Instead of writing queries from scratch, research questions are
              posed in natural language. The AI agent translates these into SQL
              queries, iterates on results, and surfaces patterns that might
              otherwise require significant technical expertise to uncover.
            </p>
          </div>
          ...
          <div className="bg-white rounded-xl border border-gray-200 p-6">
            ...
            <p className="text-gray-600 text-sm">
              The agent helped design and populate new database tables (like
              quotations and notable figures), write extraction scripts with
              proper Unicode handling, and validate results through sampling and
              temporal analysis.
            </p>
          </div>
          ...
          <div className="bg-white rounded-xl border border-gray-200 p-6">
            ...
            <p className="text-gray-600 text-sm">
              By rapidly testing hypotheses ("Who gets quoted more: philosophers
              or religious figures?"), the agent enables exploratory research
              that would traditionally require days of manual query-writing and
              data processing.
            </p>
          </div>
          ...
          <div className="bg-white rounded-xl border border-gray-200 p-6">
            ...
            <p className="text-gray-600 text-sm">
              The workflow involves constant iteration: finding false positives,
              adjusting patterns, re-running analysis, and validating against
              source material. The agent maintains context across sessions,
              learning from debugging to improve extraction quality.
            </p>
          </div>
        </div>
        ...
        <div className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-xl border border-gray-200 p-6 md:p-8">
          ...
          <p className="text-gray-700 mb-4">
            Can coding agents like Claude Code make humanities research more
            accessible? Traditional digital humanities work requires expertise
            in programming, databases, and statistical analysis. AI assistants
            may lower these barriers, allowing researchers to focus on
            interpretation rather than implementation.
          </p>
          <p className="text-gray-700 mb-6">
            This project serves as a case study: every research page here was
            created through conversation with an AI agent, from initial data
            exploration to final visualization. The agent wrote the SQL queries,
            Python scripts, and React components—guided by human questions and
            judgment.
          </p>
