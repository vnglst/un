...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      'h-10 md:h-12 px-2 md:px-4 text-left align-middle font-medium text-gray-500 text-xs md:text-sm [&:has([role=checkbox])]:pr-0',
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <td
    ref={ref}
    className={cn('p-2 md:p-4 align-middle text-sm [&:has([role=checkbox])]:pr-0', className)}
    {...props}
  />
))
