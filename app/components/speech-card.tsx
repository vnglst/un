  ...
  return (
    <Card className="hover:shadow-lg transition-shadow duration-200">
      <CardHeader>
        <div className="flex items-start justify-between">
          <div className="flex-1">
            <CardTitle className="text-lg text-un-dark-blue">
              <Link to={`/speech/${speech.id}`} className="hover:underline">
      ...
      <CardContent>
        ...
        <p className="text-gray-700 leading-relaxed">{truncateText(speech.text)}</p>
        <Link
          to={`/speech/${speech.id}`}
